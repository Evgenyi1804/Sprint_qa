...
public class RentOrderForm {
    ...
    public RentOrderForm(WebDriver driver) {
    ...
    public RentOrderForm enterComment(String newComment) {
    ...
    public RentOrderForm clickOrderButton() {
    ...
    public RentOrderForm enterAllDataRentOrder(String newDate, int days, String newColor, String newComment) {
        enterDate(newDate);
        choosePeriod(days);
